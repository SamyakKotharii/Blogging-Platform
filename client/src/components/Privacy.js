  ...
  return (
    <>
      ...
      <div className="privacy--div">
        <h2 className="privacy--title">USER INFORMATION</h2>
        ...
        <h2 className="privacy--title">LINKS TO THE OTHER SITES</h2>
        <p className="privacy--para">
        ...
        <h2 className="privacy--title">INFORMATION SHARING</h2>
        <p className="privacy--para">
        ...
        <h2 className="privacy--title">INFORMATION SECURITY</h2>
        <p className="privacy--para">
        ...
        <h2 className="privacy--title">GRIEVANCE REDRESSAL</h2>
        <p className="privacy--para">
          ...
          <a href="mailto:grievance@darkhorsestocks.in?body=My custom mail body"> grievance@darkhorsestocks.in</a>
          <br />
          
        </p>
        <hr/>
        <h4 style={{textAlign: 'center'}}>Copyright © 2023 Darkhorsestocks.in. All Rights Reserved.</h4>
      </div>
      <Footer />
    </>
  );
